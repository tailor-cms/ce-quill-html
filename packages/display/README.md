...
End-user component for the **Quill HTML** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-quill-html-display
```
...
```ts
import { Display } from '@tailor-cms/ce-quill-html-display';
```
